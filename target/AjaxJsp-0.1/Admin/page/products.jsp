<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="../sb_admin2/vendor/datatables/dataTables.bootstrap4.min.css">
            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="page/production.jsp">Production</a>
                                <a class="collapse-item" href="users.jsp">Usuarios</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="login.jspl">Login</a>
                    ...
                    <div class="sidebar-card">
                        <img class="sidebar-card-illustration mb-2" src="../sb_admin2/img/undraw_rocket.svg" alt="">
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                        ...
                                        <img class="img-profile rounded-circle"
                                            src="../sb_admin2/img/undraw_profile.svg">
                                    </a>
        ...
        <div class="container">
            ...
            <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Selecciona "Logout"
                            abajo si estas listo para cerrar tu sesiÃ³n actual.</div>
            ...
            <script type="text/javascript" src=""></script><!-- comment -->
            <script type="text/javascript" src="../swetalert/sweetalert.js"></script>
